...
#nvim ----------
export PATH=~/.config/nvim/lib/nvim-linux64/lib/:${PATH}
export PATH=~/.config/nvim/lib/nvim-linux64/bin/:${PATH}
...
#ripgrep ----------
export PATH=~/.config/nvim/lib/ripgrep-14.0.2-x86_64-unknown-linux-musl/:${PATH}
