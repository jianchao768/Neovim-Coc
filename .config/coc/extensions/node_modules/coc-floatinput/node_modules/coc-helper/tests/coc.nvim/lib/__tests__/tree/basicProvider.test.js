...
const filter_1 = require("../../tree/filter");
...
describe('HistoryInput()', () => {
    it('should manage history inputs', async () => {
        let h = new filter_1.HistoryInput();
        h.add('a');
        h.add('b');
...
describe('BasicDataProvider', () => {
    ...
    describe('getTreeItem()', () => {
        it('should get tree item from node', async () => {
            ...
            expect(item.collapsibleState).toBe(tree_1.TreeItemCollapsibleState.Collapsed);
            item = provider.getTreeItem(res[2]);
            expect(item.collapsibleState).toBe(tree_1.TreeItemCollapsibleState.None);
        });
        it('should respect expandLevel option', async () => {
            ...
            let item = provider.getTreeItem(res[0]);
            expect(item).toBeDefined();
            expect(item.collapsibleState).toBe(tree_1.TreeItemCollapsibleState.Expanded);
    ...
    describe('resolveTreeItem()', () => {
        ...
        it('should register command invoke click', async () => {
            ...
            await commands_1.default.execute(resolved.command);
...
//# sourceMappingURL=basicProvider.test.js.map