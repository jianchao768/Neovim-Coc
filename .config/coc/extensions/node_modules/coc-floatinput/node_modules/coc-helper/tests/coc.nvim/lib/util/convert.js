...
function getSymbolKind(kind) {
    switch (kind) {
        case vscode_languageserver_types_1.SymbolKind.File:
            return 'File';
        ...
        case vscode_languageserver_types_1.SymbolKind.Method:
            return 'Method';
        case vscode_languageserver_types_1.SymbolKind.Property:
            return 'Property';
        ...
        case vscode_languageserver_types_1.SymbolKind.Array:
            return 'Array';
        case vscode_languageserver_types_1.SymbolKind.Object:
            return 'Object';
        case vscode_languageserver_types_1.SymbolKind.Key:
            return 'Key';
        ...
        case vscode_languageserver_types_1.SymbolKind.Struct:
            return 'Struct';
        case vscode_languageserver_types_1.SymbolKind.Event:
            return 'Event';
        case vscode_languageserver_types_1.SymbolKind.Operator:
            return 'Operator';
