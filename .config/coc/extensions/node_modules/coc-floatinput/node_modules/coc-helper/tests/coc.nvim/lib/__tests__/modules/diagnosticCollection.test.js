...
describe('diagnostic collection', () => {
    ...
    it('should set severity for hint tags', async () => {
        ...
        let diagnostics = [{
                range: null,
                message: undefined,
                tags: [vscode_languageserver_types_1.DiagnosticTag.Deprecated]
            }, {
        ...
        expect(arr[0].severity).toBe(vscode_languageserver_types_1.DiagnosticSeverity.Hint);
        expect(arr[1].severity).toBe(vscode_languageserver_types_1.DiagnosticSeverity.Hint);
    });
