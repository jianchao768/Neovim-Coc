...
exports.nextTypoPermutation = exports.isPatternInWord = exports.isWhitespaceAtPos = exports.isSeparatorAtPos = exports.createMatches = exports.anyScore = exports.fuzzyScore = exports.fuzzyScoreGraceful = exports.fuzzyScoreGracefulAggressive = void 0;
...
function fuzzyScore(pattern, patternLow, patternStart, word, wordLow, wordStart, options = { boostFullMatch: true, firstMatchCanBeWeak: false }) {
...
function anyScore(pattern, lowPattern, patternPos, word, lowWord, wordPos, options) {
...
function isSeparatorAtPos(value, index) {
    ...
    switch (code) {
        ...
        case undefined:
            return false;
        default:
            if ((0, string_1.isEmojiImprecise)(code)) {
                return true;
            }
            return false;
    }
}
exports.isSeparatorAtPos = isSeparatorAtPos;
...
exports.isWhitespaceAtPos = isWhitespaceAtPos;
