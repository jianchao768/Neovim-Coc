...
const floating_1 = require("./modules/floating");
...
class FloatingWindow {
    ...
    static async create(options = {}) {
        ...
        const [bufnr, borderBufnr] = await floating_1.floatingModule.create.call((_b = options.name) !== null && _b !== void 0 ? _b : '', initedExecute, (_c = options.hasBorderBuf) !== null && _c !== void 0 ? _c : true, borderInitedExecute);
        const floatingUtil = new FloatingUtil_1.FloatingUtil(this.srcId);
    ...
    constructor(bufnr, borderBufnr, createOptions, mode, util) {
        ...
        if (borderBufnr) {
            this.borderBuffer = coc_nvim_1.workspace.nvim.createBuffer(borderBufnr);
            this.disposables.push(coc_nvim_1.events.on('BufWinLeave', util_2.helperLogger.asyncCatch(async (curBufnr) => {
                // close border win
                if (this.borderBufnr && curBufnr === this.bufnr) {
                    await util_1.utilModule.closeWinByBufnr.call([this.borderBufnr]);
                }
            })));
        }
    }
    ...
    setLinesNotifier(options) {
        return notifier_1.Notifier.create(() => {
    ...
    async openNotifier(options) {
        ...
        if (options.width <= 0 || options.height <= 0) {
            return notifier_1.Notifier.noop();
        }
        const notifiers = [];
        ...
        if (options.borderOnly && borderWinConfig) {
            notifiers.push(floating_1.floatingModule.open.callNotifier(this.bufnr, borderWinConfig, borderInitedExecute, null, null, '', false, this.util.nvimWinHl(options)));
            notifiers.push(this.util.renderBorderNotifier(this.buffer, ctx, options, borderWinConfig));
        }
        else {
            notifiers.push(floating_1.floatingModule.open.callNotifier(this.bufnr, winConfig, initedExecute, (_a = this.borderBufnr) !== null && _a !== void 0 ? _a : null, borderWinConfig !== null && borderWinConfig !== void 0 ? borderWinConfig : null, borderInitedExecute, this.getFocus(options), this.util.nvimWinHl(options)));
        }
        if (coc_nvim_1.workspace.isNvim && this.borderBuffer && borderWinConfig) {
            notifiers.push(this.util.renderBorderNotifier(this.borderBuffer, ctx, options, borderWinConfig));
        }
        notifiers.push(this.setLinesNotifier(options), notifier_1.Notifier.create(() => {
            if (options.filetype) {
                this.buffer.setOption('filetype', options.filetype, true);
            }
        }));
        return notifier_1.Notifier.combine(notifiers);
    }
    async open(options) {
    ...
    async resumeNotifier(options) {
        ...
        return notifier_1.Notifier.create(() => {
            var _a;
            floating_1.floatingModule.resume.callNotify(this.bufnr, winConfig, (_a = this.borderBufnr) !== null && _a !== void 0 ? _a : null, borderWinConfig !== null && borderWinConfig !== void 0 ? borderWinConfig : null, this.getFocus(options), this.util.nvimWinHl(options));
    ...
    async resizeNotifier(options) {
        ...
        const notifiers = [];
        if (options.borderOnly && borderWinConfig) {
            notifiers.push(floating_1.floatingModule.update.callNotifier(this.bufnr, borderWinConfig, null, null, this.util.nvimWinHl(options)));
            notifiers.push(this.util.renderBorderNotifier(this.buffer, ctx, options, borderWinConfig));
        }
        else {
            notifiers.push(floating_1.floatingModule.update.callNotifier(this.bufnr, winConfig, (_a = this.borderBufnr) !== null && _a !== void 0 ? _a : null, borderWinConfig !== null && borderWinConfig !== void 0 ? borderWinConfig : null, this.util.nvimWinHl(options)));
        }
        if (coc_nvim_1.workspace.isNvim && this.borderBuffer && borderWinConfig) {
            notifiers.push(this.util.renderBorderNotifier(this.borderBuffer, ctx, options, borderWinConfig));
        }
        notifiers.push(notifier_1.Notifier.create(() => {
            if (coc_nvim_1.workspace.isVim) {
                this.nvim.command('redraw!', true);
            }
        }));
    ...
    async win() {
        const winid = await floating_1.floatingModule.winid.call(this.bufnr);
        return winid ? this.nvim.createWindow(winid) : undefined;
    }
    async borderWin() {
        const borderWinid = await floating_1.floatingModule.winid.call(this.bufnr);
        return borderWinid ? this.nvim.createWindow(borderWinid) : undefined;
    }
    closeNotifier() {
        return floating_1.floatingModule.close.callNotifier(this.bufnr);
    }
    async close() {
