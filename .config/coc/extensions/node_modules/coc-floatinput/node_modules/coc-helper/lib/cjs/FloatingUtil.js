...
class FloatingUtil {
    ...
    async createContext(options) {
        ...
        return ((_a = options.context) !== null && _a !== void 0 ? _a : {
            lines: coc_nvim_1.workspace.env.lines,
            columns: coc_nvim_1.workspace.env.columns - coc_nvim_1.workspace.env.cmdheight - 1,
            globalCursorPosition: await util_1.utilModule.globalCursorPosition.call(),
            title: options.title
                ? {
                    text: options.title,
                    width: await (0, util_2.displayWidth)(options.title),
                }
                : { text: '', width: 0 },
    ...
    winConfig(ctx, options, updateCursorPosition = true) {
        return coc_nvim_1.workspace.isVim
    ...
    addHighlightsNotify(buf, highlights) {
        for (const hl of highlights) {
            ...
            buf.highlightRanges(this.srcId, hl.hlGroup, [
                coc_nvim_1.Range.create(hl.line, hl.colStart, hl.line, hl.colEnd),
            ]);
        }
    }
}
exports.FloatingUtil = FloatingUtil;
